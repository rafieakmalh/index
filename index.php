...
<body>
    ...
    <div class="sidebar">
        <header>
            <div class="navbar-brand">
                <a href="interface.html"><img src="logo.png" alt="myfeed image"></a>
            </div>
        </header>
        <ul>
    ...
    <div id="kecil" class="container-md-fluid">
        <div class="col-md-8">
            ...
            <img width="700px" height="600px" src="internasional.jpg" alt="">
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="../Matahari Buatan/MatahariBuatan.html"><img src="../Matahari Buatan/amaterasu.jpg" class="card-img" alt="..."></a>
                    </div>
                    <div class="col-sm-7">
                        <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="../Mensos Korup/Mensos Korupsi.html" target="_blank" style="pointer-events: fill;"><img src="../Mensos Korup/mensos.jpg" class="card-img" alt="..."></a>
                    </div>
                    <div class="col-sm-7">
                        <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="../Windows 2021/windows.html"><img src="../Windows 2021/internasional.jpg" class="card-img" alt="..."></a>
                    </div>
                    <div class="col-sm-7">
                        <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="../COv/Tambah 6.033 Pasien, Kasus Covid-19 RI Hampir Tembus 600.000.html"><img src="../COv/FotoBeritaPertama.jpg" class="card-img" alt="..."></a>
                    </div>
                    <div class="col-sm-7">
                        <div class="card-body">
